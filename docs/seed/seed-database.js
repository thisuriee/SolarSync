...
const PASSWORD_HASH =
  "AQAAAAIAAYagAAAAELVMjjH5pePugJjJ7Elg0nAwESj7xZDE9+yL5RxOA5vouNvIZLl9ZMlEdHRKYN7buQ=="; // all seed users share one password
...
// =============================================================================
const U = {
  bo1: oid("650000000000000000000001"),
  bo2: oid("650000000000000000000002"),
  op1: oid("650000000000000000000011"),
  op2: oid("650000000000000000000012"),
  p1: oid("650000000000000000000021"),
  p2: oid("650000000000000000000022"),
  p3: oid("650000000000000000000023"),
  p4: oid("650000000000000000000024"),
  p5: oid("650000000000000000000025"),
  p6: oid("650000000000000000000026"),
};
...
db.UsersDetail.insertMany([
...

  {
    _id: U.bo2,
    nic: null,
    username: "backoffice.officer",
    fullName: "Chathura Bandara",
    email: "chathura.b@smartsolar.lk",
    phone: "0112345002",
    address: null,
    passwordHash: PASSWORD_HASH,
    role: "Backoffice",
...

  {
    ...
    fullName: "Isuru Gunawardena",
    email: "isuru.g@smartsolar.lk",
    phone: "0112345011",
    address: null,
    passwordHash: PASSWORD_HASH,
    role: "GridOperator",
...

  {
    _id: U.op2,
    nic: null,
    username: "operator.negombo",
    fullName: "Malsha Ekanayake",
    email: "malsha.e@smartsolar.lk",
    phone: "0112345012",
    address: null,
    passwordHash: PASSWORD_HASH,
    role: "GridOperator",
...

  {
    ...
    phone: "0771234505",
    address: "21 Station Road, Wattala",
    passwordHash: PASSWORD_HASH,
    role: "Prosumer",
    status: "Pending",
    deactivationRequestedAt: null,
...

  {
    ...
    phone: "0771234506",
    address: "3 Temple Road, Ragama",
    passwordHash: PASSWORD_HASH,
    role: "Prosumer",
    status: "Deactivated",
    deactivationRequestedAt: hrs(-96),
    activatedBy: U.bo1,
    activatedAt: hrs(-400),
    createdAt: hrs(-420),
    updatedAt: hrs(-96),
...
// =============================================================================
const S = {
  s1: oid("660000000000000000000001"),
  s2: oid("660000000000000000000002"),
  s3: oid("660000000000000000000003"),
  s4: oid("660000000000000000000004"),
...
db.SolarStationInfo.insertMany([
  {
    _id: S.s1,
    stationName: "Colombo Fort Solar Hub",
    addressLine: "12 Chatham Street",
    city: "Colombo",
    location: { type: "Point", coordinates: [79.8428, 6.9344] },
    capacityKWh: 250.0,
    totalBatterySlots: 8,
    status: "Active",
    operatingSchedule: WEEK,
    createdBy: U.bo1,
    createdAt: hrs(-1000),
    updatedAt: hrs(-1000),
  },
  ...
  {
    _id: S.s2,
    stationName: "Negombo Beach Microgrid",
    addressLine: "104 Lewis Place",
    city: "Negombo",
  ...
  {
    _id: S.s3,
    stationName: "Gampaha Central Node",
    addressLine: "56 Bauddhaloka Mawatha",
    city: "Gampaha",
    location: { type: "Point", coordinates: [80.0, 7.0917] },
    capacityKWh: 320.0,
  ...
  {
    _id: S.s4,
    stationName: "Ja-Ela Industrial Array",
    addressLine: "Zone 2, Ekala Industrial Park",
    city: "Ja-Ela",
  ...
  {
    _id: S.s5,
    stationName: "Wattala Grid Hub",
    addressLine: "9 Hendala Road",
    city: "Wattala",
...
function slot(id, stationId, startH, endH, cap, kwh) {
  return {
    _id: id,
    stationId: stationId,
    slotStart: hrs(startH),
    slotEnd: hrs(endH),
    totalCapacity: cap,
    reservedCount: 0,
    energyPerSlotKWh: kwh,
    status: "Open",
    createdAt: hrs(-200),
    updatedAt: hrs(-200),
  };
...
function res(
  ...
  // slotEnd is copied from the slot, exactly as slotStart already is, so the QR
  // expiry (slotEnd + QrSettings.TokenExpiryHours) has a real value to work from.
  // Without it the reservation stores 0001-01-01 and every issued QR is expired
  // on arrival.
  const slot = db.EnergyBookingSlots.findOne({ _id: slotId });
  ...
  const base = {
    ...
    stationId: stationId,
    slotId: slotId,
    slotStart: hrs(slotStartHours),
    slotEnd: slot ? slot.slotEnd : null,
    energyKWh: kwh,
    status: status,
    createdAt: hrs(-72),
    updatedAt: hrs(-72),
...
db.EnergyReservation.insertMany([
  ...
  res("11", NIC.p1, S.s1, L.l1, -160, 14.0, "Completed", {
    ...
    approvedBy: U.op1,
    approvedAt: hrs(-200),
    qrTokenHash: "__USED_TOKEN_HASH_1__",
    qrIssuedAt: hrs(-200),
    qrExpiresAt: hrs(-154),
    verifiedByOperatorId: U.op1,
    completedAt: hrs(-158),
  }),
  ...
  res("12", NIC.p2, S.s2, L.l5, -136, 8.5, "Completed", {
    ...
    approvedBy: U.op2,
    approvedAt: hrs(-180),
    qrTokenHash: "__USED_TOKEN_HASH_2__",
    qrIssuedAt: hrs(-180),
    qrExpiresAt: hrs(-130),
    verifiedByOperatorId: U.op2,
    completedAt: hrs(-134),
  }),
  ...
  res("13", NIC.p3, S.s3, L.l9, -112, 16.0, "Completed", {
    ...
    approvedBy: U.op1,
    approvedAt: hrs(-160),
    qrTokenHash: "__USED_TOKEN_HASH_3__",
    qrIssuedAt: hrs(-160),
    qrExpiresAt: hrs(-106),
    verifiedByOperatorId: U.op1,
    completedAt: hrs(-110),
  ...
  res("16", NIC.p2, S.s4, L.l15, 106, 45.0, "Rejected", {
    rejectionReason:
      "Requested energy exceeds available allocation for this slot.",
    updatedAt: hrs(-60),
  }),
]);
...
// =============================================================================
db.UsersDetail.createIndex(
  { nic: 1 },
  { unique: true, partialFilterExpression: { nic: { $type: "string" } } },
); // partial, not sparse: web users store nic: null
...
db.EnergyReservation.find().forEach((r) => {
  if (nics.indexOf(r.prosumerNIC) === -1) {
    print("DANGLING NIC: " + r._id);
    bad++;
  }
  if (stationIds.indexOf(String(r.stationId)) === -1) {
    print("DANGLING stationId: " + r._id);
    bad++;
  }
  if (slotIds.indexOf(String(r.slotId)) === -1) {
    print("DANGLING slotId: " + r._id);
    bad++;
  }
});
db.EnergyBookingSlots.find().forEach((s) => {
  if (stationIds.indexOf(String(s.stationId)) === -1) {
    print("DANGLING stationId on slot: " + s._id);
    bad++;
  }
  if (s.reservedCount > s.totalCapacity) {
    print("OVER CAPACITY: " + s._id);
    bad++;
  }
});
...
print(
  bad === 0
    ? "OK — every reference resolves, no slot over capacity."
    : "FAILED — " + bad + " problem(s) above.",
);

print("\n--- demo fixtures ---");
print(
  "Inside-12-hours slot   : " + L.l1 + " (reservation ...09 starts in ~8h)",
);
